                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        ...
                        <ul class="folder-list m-b-md" style="padding: 0">
                            ...
                            <li><a href="<?= SITE;?>administrator/messages/envoyes/"><i class="fa fa-envelope-o"></i> Envoyés</a></li>
                        </ul>
               ...
               <h2>Composer un mesage</h2>
                ...
                <div class="mail-box">
	                ...
	                ?>
	                    ...
	                    <form class="form-horizontal" method="POST" action="<?=SITE;?>administrator/messages/compose/">
			            	...
			            	<div class="clear20"></div>
		                     ...
		                     <a href="<?=SITE;?>administrator/messages" class="btn btn-danger btn-sm pull-right" >
