            ...
            <div class="col-lg-offset-1 col-lg-10">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content padding50">
                        <div class="result">
                            ...
                            <?php
                                ...
                                if (isset($datas['result'])) {
                                    ...
                                    switch ($datas['result']) {
                                        case 'NOTSAVED':
                                           echo'<div class="alert alert-danger">Impossible d\'éffectuer cette opération. Contactez votre administrateur !.</div>';
                                            break;
                        ...
                        <div class="clear20"></div>
                        <form class="form-horizontal" action="<?php echo SITE;?>administrator/parametres/password/" method="POST"  >
