...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <a href="<?php echo SITE;?>administrator/parametres/" class="btn btn-success btn-sm floatR "><i class="fa fa-cogs mgR10"></i>Parametres</a>
    </div>
</div>
                        ...
                        <div class="result ">
                            ...
                            <?php
                                ...
                                if (isset($datas['result'])) {
                                    ...
                                    switch ($datas['result']) {
                                        case 'NOTSAVED':
                                           echo'<div class="alert alert-danger">Impossible d\'effectuer cette operation. Contactez votre administrateur !.</div>';
                                            break;
                            ...
                            <div class="clear20"></div>
                            <form class="form-horizontal" action="<?php echo SITE;?>administrator/parametres/config/" method="POST"  >
