    ...
    <div class="col-lg-12">
        <div class="wrapper wrapper-content animated fadeInUp">
            <div class="ibox float-e-margins">
        	    ...
        	    <div class="clear20"></div>
                    <h3>Modifier la baniere du site</h3>
                </div>
                <div class="ibox-content col-lg-12">
                    ...
                    <div class="col-lg-7">
                        ...
                        ?>
                        <form class="form-horizontal" action="<?php echo SITE;?>administrator/parametres/banner/" method="POST" enctype="multipart/form-data"  >

                                <div class="form-group col-lg-12">
                                   <img src="<?= SITE;?>public/images/page_banner.png" alt="Page Banner">
                                </div>
                                ...
                                <div class="form-group col-lg-8">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button name="uploadBanner" class="btn btn-w-m btn-success mgR20" type="submit">Changer</button>
