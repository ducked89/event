...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <small>Liste des comptes utilisateurs du système. Cliquer sur le nom du compte pour plus de détails.</small>
           ...
           <a href="<?= SITE;?>administrator/accounts/add/">
                         ...
                         <?php
                            ...
                            foreach ($mUsers as $mUser) {
                                echo '<tr class="gradeU odd" role="row">
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="'.SITE.'administrator/organizers/view/?idu='.$mUser->empid.'">Profil utilisateur</a></li>
                                                    <li><a href="'.SITE.'administrator/accounts/edit/?idu='.$mUser->id.'">Editer compte</a></li>
                                                    <li><a href="'.SITE.'administrator/accounts/password/?idu='.$mUser->id.'">Changer mot de passe</a></li>
                                                     <li>';

                                                    if($mUser->status==0)
                                                        echo '<a href="'.SITE.'administrator/accounts/enable/?idu='.$mUser->id.'">Activer</a></li>';
                                                    else echo '<a href="'.SITE.'administrator/accounts/disable/?idu='.$mUser->id.'">Désactiver</a></li>';
                                    ...
                                    <td class=""><a href="'.SITE.'administrator/organizers/view/?idu='.$mUser->empid.'">'.$mUser->login.'</a></td>
                                    <td class="sorting_1">';
...
$(document).ready(function(){
    $('.dataTables-example').DataTable({
        ...
        buttons: [
            {extend: 'copy'},
            {extend: 'csv'},
            {extend: 'excel', title: 'HEC_Comptes_Utilisateurs'},
            {extend: 'pdf', title: 'HEC_Profiles_Organisateurs'},
            {extend: 'print',
