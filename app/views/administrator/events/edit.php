...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-sm-12">
       ...
       <a href="<?php echo SITE;?>administrator/mentions/" class="btn btn-warning btn-sm floatR ">Mentions des notes</a>

       <a href="<?= SITE;?>administrator/events/">
               ...
               <div class="ibox float-e-margins">
                   ...
                   <div class="ibox-content col-lg-12">
                       ...
                       <div class="col-lg-7">
                           ...
                           ?>
                           <form class="form-horizontal" action="<?php echo SITE;?>administrator/events/edit/?idu=<?= $mEvaluation->id;?>" method="POST"  >
                                   <div class="clear20"></div>
                                   ...
                                   <div class="form-group">
                                       <div class="col-lg-offset-2 col-lg-10">
                                           <button name="saveEvaluation" class="btn btn-w-m btn-success mgR20" type="submit">Modifier</button>
                                            ...
                                            <a href="<?= SITE;?>administrator/events/"><button type="button" class="btn btn-w-m btn-danger floatR">Annuler</button></a>
                                       </div>
                                   </div>
                           </form>
                           <div class="clear50"></div>
