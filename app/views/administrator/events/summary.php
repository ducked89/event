...
<div class="col-lg-12">
   <div class="wrapper wrapper-content animated fadeInRight">
       ...
       <div class="row m-b-lg m-t-lg">
           ...
           <a class="btn btn-warning pull-right floatR " target="_blanK" href="<?= SITE;?>admin/evaluations/printall/?idu=<?= $myEvalue->id.'&mois='.(isset($datas['mois'])?$datas['mois']:1).'&annee='.(isset($datas['annee'])?$datas['annee']:2017);?>">Imprimer avec commentaires</a>

           <a class="btn btn-info pull-right floatR mgR20" target="_blanK" href="<?= SITE;?>admin/evaluations/print/?idu=<?= $myEvalue->id.'&mois='.(isset($datas['mois'])?$datas['mois']:1).'&annee='.(isset($datas['annee'])?$datas['annee']:2017);?>">Imprimer</a>
           <?php } ?>
           ...
           <div class="clear20"></div>
               <form action="<?=SITE;?>admin/evaluations/summarize/" method="GET">
        ...
        <?php
           ...
           echo '<div class="clear20"></div><div class="alert alert-warning">Aucune evaluation trouvée pour cette periode. Essayer avec une autre periode.</a><div class="clear20"></div>';
           else{?>
                       ...
                       <table class="table table-bordered">
                           ...
                           <tr>
                               ...
                               <?php
                                       ...
                                       if(isset($cEvaluation->notes) && count($cEvaluation->notes)>0)
                                       {
                                          $mNotes =  $cEvaluation->notes;
                                           ...
                                           foreach ($mNotes as $cNote) {
                                               if(($cNote->notes==0) || ($cNote->notes==100)) $noteInvalid11++;
                                           }
                                           $datas['evaluations'][$ev]->noteInvalid11=$noteInvalid11;
                                       }
                                       $noteInvalid11=0;
                                       $ev++;
                                   }
                                   ...
                                   $ev=0;
                                   foreach($datas['evaluations'] as $tpEval) {
                                       if(isset($tpEval->noteInvalid11) && $tpEval->noteInvalid11<4)
                                       {
                                           echo'<th>EVAL. '.($ev+1).'</th>';
                                           $ev++;
                                       }
                                   }
                                       ...
                                       echo'
                                           ...
                                           <tr class="fluid">
                                               ...
                                               foreach ($datas['evaluations'] as $cEvaluation) {
                                                   ...
                                                   if(isset($cEvaluation->noteInvalid11) && $cEvaluation->noteInvalid11<4)
                                                   {
                                                      $mNotes =  $cEvaluation->notes;
                                                       echo '<td>';
                                                       ...
                                                       if($cEvaluation->noteInvalid > 3){ }
                                                           ...
                                                           foreach ($mNotes as $cNote) {
                                                               ...
                                                               if( ($cNote->idcritere == $myCritere->id) &&
                                                                ($cNote->idevaluation == $cEvaluation->id) )
                                                                {
                                                                   if(($cNote->notes!=100) && ($cNote->notes!=0))
                                                                   {
