       ...
       <?php
           if($myEvaluation->statut==0)
               echo '<a class="btn btn-warning pull-right floatR "
                       href="'.SITE.'administrator/events/enable/?idu='.$myEvaluation->id.'">Activer</a>';
           else echo '<a class="btn btn-danger pull-right floatR "
                       href="'.SITE.'administrator/events/disable/?idu='.$myEvaluation->id.'">Desactiver</a>';

           if($myEvaluation->etat<2)
           echo'<a class="btn btn-valid pull-right floatR mgR20"
               href="'.SITE.'administrator/events/finalize/?idu='.$myEvaluation->id.'">Finaliser</a>';
           else
           echo'<a class="btn btn-valid pull-right floatR mgR20"
           href="'.SITE.'administrator/events/open/?idu='.$myEvaluation->id.'">Ouvrir</a>';

           echo' <a href="'.SITE.'administrator/events/overview/?idu='.$myEvalue->id.'" class="btn btn-info pull-right floatR mgR20"><i class="fa fa-bar-chart-o mgR10"></i>Stats</a>';
       ?>



       <a class="btn btn-success pull-right mgR20" href="<?php echo SITE;?>administrator/events">Liste évènements</a>
       ...
       <div class="col-lg-4 pull-right">
               <?php
                    if($myEvaluation->etat == 2)
                           ...
                           <a class="btn btn-valid" href="'.SITE.'administrator/events/enable/?idu='.$myEvaluation->id.'">Réactiver cette évaluation</a>
                       ';
               ?>
           </div>
   </div>
           ...
           <div class="ibox">
               ...
               <div class="ibox-content">
                   ...
                   ?>
                       ...
                       <a class="btn btn-danger floatR" href="<?php echo SITE;?>administrator/events/">Revenir</a>
                   </div>
                                   ...
                                   if($mEmpEvluation->id!=$myEvaluation->id)
                                       {
                                           echo'
                                                <div class="team-members">';
                                                   ...
                                                   <a href="'.SITE.'administrator/events/view/?idu='.$mEmpEvluation->id.'">
