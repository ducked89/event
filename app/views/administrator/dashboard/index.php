...
<div class="col-md-12">
    ...
    <a href="<?php echo SITE;?>administrator/messages/"><?= count($datas['messages']);?></strong>
    message<?= (count($datas['messages'])>1)? "s" :  " " ?></a> et

    <a href="<?php echo SITE;?>administrator/notifications/">
       ...
       <!--  <h1>Not Ready !</h1>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title"><a href="<?php echo SITE;?>administrator/events/add/">
                        <span class="label label-info pull-right"><i class="fa fa-plus mgR10"></i>Créer</span></a>
                        <h5>Evènement</h5>
                    </div>
                    <div class="ibox-content">
                        <h2 class="no-margins"><a href="<?php echo SITE;?>administrator/events/"><?= $data['nbEvaluations'][0]->nb;?> évènement<?=  ($data['nbEvaluations'][0]->nb>1)? "s" :  " " ?></a></h2>
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title"><a href="<?php echo SITE;?>administrator/organizers/add/">
                        <span class="label label-info pull-right"><i class="fa fa-plus mgR10"></i>Créer</span></a>
                        <h5>Organisateur</h5>
                    </div>
                    <div class="ibox-content">
                       <h2 class="no-margins"><a href="<?php echo SITE;?>administrator/organizers/">
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title"><a href="<?php echo SITE;?>administrator/accounts/add/">
                        <span class="label label-info pull-right"><i class="fa fa-plus mgR10"></i>Créer</span></a>
                        <h5>Utilisateur</h5>
                    </div>
                    <div class="ibox-content">
                        <h2 class="no-margins"><a href="<?php echo SITE;?>administrator/accounts/">
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     <h2 class="no-margins"><a href="<?php echo SITE;?>administrator/messages/">
        ...
        <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <a class="btn btn-xs btn-success pull-right" href="<?=SITE;?>administrator/evaluations/"><i class="fa fa-list mgR10"></i>Liste évènement</a>
                                                ...
                                                if(count($mEvaluations)>0){
                                                    foreach ($mEvaluations as $mEvaluation) {
                                                        echo '<tr class="gradeU odd" role="row">
                                                                <td class=""><a href="'.SITE.'administrator/evaluations/view/?idu='.$mEvaluation->id.'">'.$mEvaluation->title.'</a></td>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                   <ul class="employe-row">
                       <li><i class="fa fa-user mgR10"></i><a href="<?= SITE;?>administrator/accounts/add/">Créer un utilisateur</a></li>
                       <li><i class="fa fa-group mgR10"></i><a href="<?= SITE;?>administrator/organizers/">Profiles des organisateurs</a></li>
                       <li><i class="fa fa-list mgR10"></i><a href="<?= SITE;?>administrator/criteres/">Liste des critères</a></li>
                       <li><i class="fa fa-check mgR10"></i><a href="<?= SITE;?>administrator/mentions/">Liste des mentions</a></li>
                        <li><i class="fa fa-lock mgR10"></i><a href="<?= SITE;?>administrator/password/">Changer mot de passe</a></li>
                   </ul>
                </div>
            </div>
        </div>
