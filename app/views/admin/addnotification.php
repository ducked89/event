 <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <a href="<?php echo SITE;?>admin/notifications/" class="btn btn-primary btn-sm floatR">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content col-lg-12">
                    ...
                    <div class="col-lg-7">
                        ...
                        ?>
                        <form class="form-horizontal" action="<?php echo SITE;?>admin/notifications/add/" method="POST"  >
                                <div class="clear20"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button name="createNotification" class="btn btn-w-m btn-success mgR20" type="submit">Créer</button>
                                         <a href="<?= SITE;?>admin/notifications/" class="btn btn-w-m btn-danger floatR">Annuler</a>
                                    </div>
                                </div>
                        </form>
