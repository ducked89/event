 <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        ...
        <a href="<?= SITE;?>admin/evaluations/grid/">
        ...
        <form action="<?=SITE;?>admin/evaluations/">
            <div class="col-md-6">
                            ...
                            if(count($mEvaluations)>0){
                                foreach ($mEvaluations as $mEvaluation) {
                                    echo '<tr class="gradeU odd" role="row">
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="'.SITE.'admin/evaluations/view/?idu='.$mEvaluation->id.'">Dossier Evaluation</a></li>
                                                        <li><a href="'.SITE.'admin/evaluations/edit/?idu='.$mEvaluation->id.'">Editer </a></li>
                                                        ';
                                                        if($mEvaluation->etat<2)
                                                        echo'<li><a href="'.SITE.'admin/evaluations/finalize/?idu='.$mEvaluation->id.'">Finaliser</a></li>';
                                                        else
                                                        echo'<li><a href="'.SITE.'admin/evaluations/open/?idu='.$mEvaluation->id.'">Ouvrir</a></li>';

                                                        echo '<li>';

                                                        if($mEvaluation->statut==0) 
                                                            echo '<a href="'.SITE.'admin/evaluations/enable/?idu='.$mEvaluation->id.'">Activer</a></li>';
                                                        else echo '<a href="'.SITE.'admin/evaluations/disable/?idu='.$mEvaluation->id.'">Desactiver</a></li>';
                                        ...
                                        <td class=""><a href="'.SITE.'admin/evaluations/view/?idu='.$mEvaluation->id.'">'.$mEvaluation->alttitle.'</a></td>
...
$(document).ready(function(){
    $('.dataTables-example').DataTable({
        ...
        buttons: [
            {extend: 'copy'},
            {extend: 'csv'},
            {extend: 'excel', title: 'UTE_Evaluation_Employes'},
            {extend: 'pdf', title: 'UTE_Evaluations_Employes'},
            {extend: 'print',
