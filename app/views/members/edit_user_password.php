    ...
    <div class="col-lg-offset-1 col-lg-10">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" action="<?php echo SITE;?>members/profile/password/" method="POST"  >
                    ...
                    <div class="clear20"></div>
                        <div class="col-lg-offset-4 col-lg-10">
                            <button id="editpassbutton" name="cuPassword" class="btn btn-primary mgR20">Modifier</button>
