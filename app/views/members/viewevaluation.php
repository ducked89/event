...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row m-b-lg m-t-lg">
        <div class="col-md-6">
            ...
            echo'<span class="pull-right">'.$progress.'% Compléter</span>';
            ...
            echo'
                ...
                <div class="progress progress-striped active">            
                    ...
                    <div style="width: '.(100 - $progress).'%" class="progress-bar progress-bar-default">
                                <span class="sr-only">40% Complète (danger)</span>
                            </div>
        ...
        <div class="col-lg-4 pull-right">      
                <?php
                     if($myEvaluation->etat == 2)
                            echo '
                            <div class="alert alert-success "><strong>Cette évaluation a été completée et soumise.</strong> Merci pour votre collaboration.</div>
                            <span class="infored pull-right">NB: Vous ne pouvez effectuer aucune modification dans cette évaluation.</sapn>
                        ';
                ?>
            </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="ibox">
                <div class="ibox-title"><h3>Critères d'évaluation</h3></div>
                <div class="ibox-content">
                    ...
                    <div class="panel-group payments-method" id="accordion">
                        ...
                        <a class="btn btn-danger floatR" href="<?php echo SITE;?>members/evaluations/">Revenir</a>
                        <div class="clear20"></div>
                    </div>
                </div>
            </div>
